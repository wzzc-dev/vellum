...
- Mermaid 流程图、序列图、状态图、类图、ER 图和饼图的轻量 Live Preview 摘要
- 上标脚注引用与脚注定义预览
- Markdown 与常见代码块语言的语法高亮
- 大纲侧边栏和工作区文件树
- 查找与替换
- 命令面板
- 应用内偏好设置，可调整主题、写作模式和图片资源
- 粘贴或拖放图片到可配置的文档资源目录
- 导出适合打印的 HTML，并复制本地图片资源到导出文件旁
- 导出并打开适合打印的 HTML，用于浏览器打印或另存 PDF
- 导出的 HTML 可渲染数学公式和 Mermaid 图表
- 自动保存
- 监听文件外部变更、删除、重命名
- 冲突提示与处理
- 启动时恢复上次打开的文件
