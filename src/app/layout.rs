...
pub(super) fn position_for_byte_offset(text: &str, byte_offset: usize) -> (usize, usize) {
...
pub(super) fn activation_cursor_offset(text: &str) -> usize {
    text.trim_end_matches(['\r', '\n']).len()
}

pub(super) fn style_active_input_for_block(input: Input, kind: &BlockKind) -> Input {
...
#[derive(Clone, Copy)]
pub(super) struct BlockLayoutMetrics {
    pub(super) font_size: f32,
    pub(super) line_height: f32,
    pub(super) row_spacing_y: f32,
    pub(super) block_padding_y: f32,
    pub(super) extra_height: f32,
}

pub(super) fn block_layout_metrics(kind: &BlockKind) -> BlockLayoutMetrics {
    match kind {
...
pub(super) fn markdown_preview_style() -> TextViewStyle {
...
pub(super) fn count_document_words(text: &str) -> usize {
...
pub(super) fn adjust_block_markup(text: &str, deepen: bool) -> Option<String> {
