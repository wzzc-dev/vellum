...
- Confirm the Mermaid sequence note and loop fragment remain visible in preview.
...
- Confirm the exported sequence diagram includes the note and loop fragment when browser Mermaid rendering is unavailable.
